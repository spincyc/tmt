...
An origin stamp object has exactly `repo` (nonempty source path), `commit`
(source commit, `"unknown"` when unresolvable), and `sha256` (64 lowercase
hex characters of the copied executable).
